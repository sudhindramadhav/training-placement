...
export default function AddWorkshops() {
      ...
      <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <div class="mb-10 md:mb-16">
            <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Adding Workshop Details</h2>
          ...
          <form class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
              ...
              <input name="Title" onChange={changeHandler} value={Title} class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
            </div>
            ...
            <div class="sm:col-span-2">
              ...
              <textarea name="Description" onChange={changeHandler} value={Description} class="h-64 w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
            </div>
            ...
            <div className="relative mt-2">
              ...
              {isSkillsOpen && (
                <ul className="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm" tabIndex="-1" role="listbox" aria-labelledby="listbox-label" aria-activedescendant="listbox-option-3">
                  ...
                  <li onClick={() => handleSkillsClickSelect('ALL')} className="text-gray-900 relative cursor-default select-none py-2 pl-3 pr-9" id="listbox-option-0" role="option" aria-selected="false">
                    <div className="flex items-center">
                      <span className="font-normal ml-3 block truncate">ALL</span>
                    </div>
            ...
            <div class="flex items-center justify-between sm:col-span-2">
              <button onClick={loginHandler} class="inline-block rounded-lg bg-indigo-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Send</button>
